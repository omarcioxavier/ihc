    ...
    public partial class FirstMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.tipoUsuario", t => t.us_tu_cod, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.estado", t => t.ci_es_cod, cascadeDelete: false)
                .Index(t => t.ci_es_cod);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.cidade", t => t.em_ci_cod, cascadeDelete: false)
                .ForeignKey("dbo.tipoEmitente", t => t.em_te_cod, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.cidade", t => t.en_ci_cod, cascadeDelete: false)
                .ForeignKey("dbo.emitente", t => t.en_em_cod, cascadeDelete: false)
                .ForeignKey("dbo.usuario", t => t.en_us_cod, cascadeDelete: false)
                .Index(t => t.en_us_cod)
                .Index(t => t.en_em_cod)
                .Index(t => t.en_ci_cod);
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    ca_ca_cod = c.Int(nullable: false),
                })
                .PrimaryKey(t => t.ca_cod)
                .ForeignKey("dbo.categoria", t => t.ca_ca_cod)
                .Index(t => t.ca_ca_cod);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.categoria", t => t.it_ca_cod, cascadeDelete: false)
                .ForeignKey("dbo.unidadeMedida", t => t.it_um_cod, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.item", t => t.ip_it_cod, cascadeDelete: false)
                .Index(t => t.ip_it_cod);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.item", t => t.li_it_cod, cascadeDelete: false)
                .Index(t => t.li_it_cod);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.emitente", t => t.pe_em_cod, cascadeDelete: false)
                .ForeignKey("dbo.itensPedido", t => t.pe_ip_cod, cascadeDelete: false)
                .ForeignKey("dbo.usuario", t => t.pe_us_cod, cascadeDelete: false)
                .Index(t => t.pe_us_cod)
                .Index(t => t.pe_em_cod)
                .Index(t => t.pe_ip_cod);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.pedido", t => t.sn_pe_cod, cascadeDelete: false)
                .Index(t => t.sn_pe_cod);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.entradaNF", t => t.me_en_cod, cascadeDelete: false)
                .ForeignKey("dbo.item", t => t.me_it_cod, cascadeDelete: false)
                .ForeignKey("dbo.saidaNF", t => t.me_sn_cod, cascadeDelete: false)
                .Index(t => t.me_it_cod)
                .Index(t => t.me_sn_cod)
                .Index(t => t.me_en_cod);
        }
        ...
        {
            DropForeignKey("dbo.cidade", "ci_es_cod", "dbo.estado");
            DropForeignKey("dbo.emitente", "em_te_cod", "dbo.tipoEmitente");
            DropForeignKey("dbo.saidaNF", "sn_pe_cod", "dbo.pedido");
            DropForeignKey("dbo.usuario", "us_tu_cod", "dbo.tipoUsuario");
            DropForeignKey("dbo.pedido", "pe_us_cod", "dbo.usuario");
            DropForeignKey("dbo.entradaNF", "en_us_cod", "dbo.usuario");
            DropForeignKey("dbo.pedido", "pe_ip_cod", "dbo.itensPedido");
            DropForeignKey("dbo.itensPedido", "ip_it_cod", "dbo.item");
            DropForeignKey("dbo.pedido", "pe_em_cod", "dbo.emitente");
            DropForeignKey("dbo.movimentoEstoque", "me_sn_cod", "dbo.saidaNF");
            DropForeignKey("dbo.item", "it_um_cod", "dbo.unidadeMedida");
            DropForeignKey("dbo.movimentoEstoque", "me_it_cod", "dbo.item");
            DropForeignKey("dbo.logItem", "li_it_cod", "dbo.item");
            DropForeignKey("dbo.item", "it_ca_cod", "dbo.categoria");
            DropForeignKey("dbo.categoria", "ca_ca_cod", "dbo.categoria");
            DropForeignKey("dbo.movimentoEstoque", "me_en_cod", "dbo.entradaNF");
            DropForeignKey("dbo.entradaNF", "en_em_cod", "dbo.emitente");
            DropForeignKey("dbo.entradaNF", "en_ci_cod", "dbo.cidade");
            DropForeignKey("dbo.emitente", "em_ci_cod", "dbo.cidade");
            DropIndex("dbo.usuario", new[] { "us_tu_cod" });
            DropIndex("dbo.usuario", new[] { "us_login" });
            DropIndex("dbo.itensPedido", new[] { "ip_it_cod" });
            DropIndex("dbo.pedido", new[] { "pe_ip_cod" });
            DropIndex("dbo.pedido", new[] { "pe_em_cod" });
            DropIndex("dbo.pedido", new[] { "pe_us_cod" });
            DropIndex("dbo.saidaNF", new[] { "sn_pe_cod" });
            DropIndex("dbo.logItem", new[] { "li_it_cod" });
            DropIndex("dbo.categoria", new[] { "ca_ca_cod" });
            DropIndex("dbo.item", new[] { "it_um_cod" });
            DropIndex("dbo.item", new[] { "it_ca_cod" });
            DropIndex("dbo.item", new[] { "it_ean" });
            DropIndex("dbo.movimentoEstoque", new[] { "me_en_cod" });
            DropIndex("dbo.movimentoEstoque", new[] { "me_sn_cod" });
            DropIndex("dbo.movimentoEstoque", new[] { "me_it_cod" });
            DropIndex("dbo.entradaNF", new[] { "en_ci_cod" });
            DropIndex("dbo.entradaNF", new[] { "en_em_cod" });
            DropIndex("dbo.entradaNF", new[] { "en_us_cod" });
            DropIndex("dbo.emitente", new[] { "em_te_cod" });
            DropIndex("dbo.emitente", new[] { "em_ci_cod" });
            DropIndex("dbo.emitente", new[] { "em_inscricaoEstadual" });
            DropIndex("dbo.emitente", new[] { "em_documento" });
            DropIndex("dbo.cidade", new[] { "ci_es_cod" });
